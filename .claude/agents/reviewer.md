...
- **判定を後から降格してはいけない**。降格禁止ルール（`https://github.com/Layer2-Architect/SPEC-compiling-pipeline/blob/v1.0.0/ja/review-guidelines/severity.md` §2）
...
詳細は `https://github.com/Layer2-Architect/SPEC-compiling-pipeline/blob/v1.0.0/ja/review-guidelines/perspectives.md` を参照。**1 セッション内で順次** 実行（並列 sub-agent ではない）。
...
詳細: `https://github.com/Layer2-Architect/SPEC-compiling-pipeline/blob/v1.0.0/ja/review-guidelines/severity.md` §2

## 起動時に読むファイル

- `https://github.com/Layer2-Architect/SPEC-compiling-pipeline/blob/v1.0.0/ja/review-guidelines/perspectives.md` — 9 観点の詳細
- `https://github.com/Layer2-Architect/SPEC-compiling-pipeline/blob/v1.0.0/ja/review-guidelines/severity.md` — severity 階層 + 降格禁止
- `https://github.com/Layer2-Architect/SPEC-compiling-pipeline/blob/v1.0.0/ja/review-guidelines/ai-antipattern.md` — AI 特有の罠
- `https://github.com/Layer2-Architect/SPEC-compiling-pipeline/blob/v1.0.0/ja/README.md` — ハードルール 10 個
