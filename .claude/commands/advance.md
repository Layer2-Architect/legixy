...
ローカル運用での AI レビュアゲートを起動する。`docs/DevProc_V4/08-gates.md` §17 のローカル運用フローに従う。
...
Reviewer は `docs/DevProc_V4/review-guidelines/perspectives.md` の 9 観点を順次チェックし、末尾に `<!-- VERDICT:APPROVE -->` / `<!-- VERDICT:REQUEST_CHANGES -->` / `<!-- VERDICT:NEEDS_HUMAN -->` のいずれかを出力する。
