...
ローカル運用での AI レビュアゲートを起動する。`https://github.com/Layer2-Architect/SPEC-compiling-pipeline/blob/v1.0.0/ja/08-gates.md` §17 のローカル運用フローに従う。
...
Reviewer は `https://github.com/Layer2-Architect/SPEC-compiling-pipeline/blob/v1.0.0/ja/review-guidelines/perspectives.md` の 9 観点を順次チェックし、末尾に `<!-- VERDICT:APPROVE -->` / `<!-- VERDICT:REQUEST_CHANGES -->` / `<!-- VERDICT:NEEDS_HUMAN -->` のいずれかを出力する。
